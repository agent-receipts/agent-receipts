...
MCP proxy with action receipts, policy engine, risk scoring, and intent tracking. Built on [agent-receipts/sdk-go](https://github.com/agent-receipts/ar/tree/main/sdk/go).
